...
(function()
{
    ...
    if (
        (
            !window.location.href.includes("vw_parts") &&
            !window.location.href.includes("vwclassic_parts") &&
            !window.location.href.includes("vn_parts")
        )
    )
    {
        return;
    ...
    const createLogo = () =>
    {
        ...
        logo.textContent = "PL24 Helper - Volkswagen";
