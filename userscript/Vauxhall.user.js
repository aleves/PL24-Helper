...
// ==UserScript==
// @name         PL24 Helper - Vauxhall
// @namespace    Violentmonkey Scripts
// @version      1.00
// @description  PL24 Helper - Vauxhall
// @author       aleves
// @match        https://www.partslink24.com/opel/vauxhall_parts/*
...
(function()
{
    ...
    logoDiv.textContent = "PL24 Helper - Vauxhall";
    ...
    if (document.querySelector("#illustration-imageview-container"))
    {
        ...
        downloadBtn.addEventListener("click", () =>
        {
            ...
            const filename = `Vauxhall_${number}`;
