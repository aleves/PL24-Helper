...
// ==UserScript==
// @name         PL24 Helper - Polestar
// @namespace    Violentmonkey Scripts
// @version      1.00
// @description  PL24 Helper - Polestar
// @author       aleves
// @match        https://www.partslink24.com/volvo/polestar_parts/*
...
(function()
{
    ...
    logoDiv.textContent = "PL24 Helper - Polestar";
    ...
    */
    ...
    if (document.querySelector("#illustration-imageview-container"))
    {
        ...
        downloadBtn.addEventListener("click", () =>
        {
            ...
            const filename = `Polestar_${number}`;
