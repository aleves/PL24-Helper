...
// ==UserScript==
// @name         PL24 Helper - Alfa Romeo
// @namespace    Violentmonkey Scripts
// @version      1.00
// @description  PL24 Helper - Alfa Romeo
// @author       aleves
// @match        https://www.partslink24.com/fiatspa/alfa_parts/*
...
(function()
{
    ...
    logoDiv.textContent = "PL24 Helper - Alfa Romeo";
    ...
    if (document.querySelector("#illustration-imageview-container"))
    {
        ...
        downloadBtn.addEventListener("click", () =>
        {
            ...
            const filename = `AlfaRomeo_${number}`;
