...
(function()
{
    ...
    if (
        (
            !window.location.href.includes("mercedes_parts") &&
            !window.location.href.includes("mercedesclassic_parts") &&
            !window.location.href.includes("mercedestrucks_parts") &&
            !window.location.href.includes("mercedesunimog_parts") &&
            !window.location.href.includes("mercedesvans_parts")
        )
    )
    {
        return;
