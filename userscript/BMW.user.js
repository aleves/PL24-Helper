...
(function()
{
    ...
    if (
        (
            !window.location.href.includes("bmw_parts") &&
            !window.location.href.includes("bmwclassic_parts") &&
            !window.location.href.includes("bmwmotorrad_parts") &&
            !window.location.href.includes("bmwmotorradclassic_parts")
        )
    )
    {
        return;
