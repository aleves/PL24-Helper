...
// @include      https://www.partslink24.com/ford/fordt_parts/*
...
(function()
{
            ...
            priceTds.forEach((td) =>
            {
                ...
                else
                {
                    const partNumber = td.closest("tr")
                        .querySelector(".partinfoFinisCol")
                        .innerText.trim();
    ...
    if (document.querySelector("#partin4dlg"))
    {
        ...
        const runCode = () =>
        {
            const partnoTds = document.querySelectorAll("#partin4content td.partinfoFinisCol");
