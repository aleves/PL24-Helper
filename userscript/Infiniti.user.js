...
// ==UserScript==
// @name         PL24 Helper - Infiniti
// @namespace    Violentmonkey Scripts
// @version      1.00
// @description  PL24 Helper - Infiniti
// @author       aleves
// @match        https://www.partslink24.com/nissan/infiniti_parts/*
...
(function()
{
    ...
    logoDiv.textContent = "PL24 Helper - Infiniti";
    ...
    if (document.querySelector("#illustration-imageview-container"))
    {
        ...
        downloadBtn.addEventListener("click", () =>
        {
            ...
            const filename = `Infiniti_${number}`;
